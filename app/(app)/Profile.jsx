...
export default function Profile() {
  ...
  const loadProfileData = async () => {
    try {
      ...
      setMedicineStats(statsData.map(stat => ({
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <View style={styles.profileInfo}>
          <Image
            source={{ uri: profile?.photoUrl || 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=200&auto=format&fit=crop' }}
            style={styles.profilePhoto}
          />
          <View style={styles.nameContainer}>
      ...
      {medicineStats.length > 0 ? (
        ...
        <View style={styles.noStatsContainer}>
          <Text style={styles.noStatsText}>No medicine statistics available</Text>
        </View>
      )}
